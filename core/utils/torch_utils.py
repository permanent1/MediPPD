...
from core.utils.cpu import CPUInfo
...
def get_cpu_info():
    ...
    from core.utils import PERSISTENT_CACHE  # avoid circular import error
...
def select_device(device="", newline=False, verbose=True):
    ...
    # Auto-select GPUs
    if "-1" in device:
        from core.utils.autodevice import GPUInfo
...
def profile_ops(input, ops, n=10, device=None, max_num_obj=0):
    ...
    Examples:
        >>> from core.utils.torch_utils import profile_ops
