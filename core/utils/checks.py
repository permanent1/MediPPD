...
def check_file(file, suffix="", download=True, download_dir=".", hard=True):
    ...
    if (
        ...
        from core.utils.callbacks.platform import resolve_platform_uri
...
def collect_system_info():
    ...
    from core.utils import ENVIRONMENT  # scope to avoid circular import
    from core.utils.torch_utils import get_cpu_info, get_gpu_info
...
def check_amp(model):
    ...
    Examples:
        ...
        >>> check_amp(model)
    """
    from core.utils.torch_utils import autocast
...
def is_intel():
    ...
    """
    from core.utils.torch_utils import get_cpu_info
