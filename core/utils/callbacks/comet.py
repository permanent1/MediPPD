...
from core.utils import LOGGER, RANK, SETTINGS, TESTS_RUNNING, ops
from core.utils.metrics import ClassifyMetrics, DetMetrics, OBBMetrics, PoseMetrics, SegmentMetrics
...
def _log_plots(experiment, trainer) -> None:
    ...
    Examples:
        >>> from core.utils.callbacks.comet import _log_plots
