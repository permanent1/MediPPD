...
from core.utils import ENVIRONMENT, GIT, LOGGER, PYTHON_VERSION, RANK, SETTINGS, TESTS_RUNNING, colorstr
...
try:
    ...
    from core.utils.logger import ConsoleLogger, SystemLogger
    from core.utils.torch_utils import model_info_for_loggers
