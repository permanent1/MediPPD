...
from core.nn.modules import Detect, Pose, Segment
from core.utils import LOGGER, WINDOWS
from core.utils.patches import onnx_export_patch
from core.utils.tal import make_anchors
from core.utils.torch_utils import copy_attr
