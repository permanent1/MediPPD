...
from core.utils.git import GitRepo
from core.utils.patches import imread, imshow, imwrite, torch_save  # for patches
from core.utils.tqdm import TQDM  # noqa
...
# Set logger
LOGGER = set_logging(LOGGING_NAME, verbose=VERBOSE)  # define globally (used in train.py, val.py, predict_stage1.py, etc.)
...
class SettingsManager(JSONDict):
    ...
    def __init__(self, file=SETTINGS_FILE, version="0.0.6"):
        ...
        from core.utils.torch_utils import torch_distributed_zero_first
