...
from core.utils import IS_COLAB, IS_KAGGLE, LOGGER, TryExcept, ops, plt_settings, threaded
from core.utils.checks import check_font, check_version, is_ascii
...
class Annotator:
    ...
    Examples:
        >>> from core.utils.plotting import Annotator
