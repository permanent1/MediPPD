...
from core.utils import ARGV, ENVIRONMENT, GIT, IS_PIP_PACKAGE, ONLINE, PYTHON_VERSION, RANK, SETTINGS, TESTS_RUNNING
from core.utils.downloads import GITHUB_ASSETS_NAMES
