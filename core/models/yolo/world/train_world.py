...
from core.data import YOLOConcatDataset, build_grounding, build_yolo_dataset
from core.data.utils import check_det_dataset
from core.models.yolo.world import WorldTrainer
from core.utils import DATASETS_DIR, DEFAULT_CFG, LOGGER
from core.utils.torch_utils import unwrap_model
...
class WorldTrainerFromScratch(WorldTrainer):
    ...
    Examples:
        >>> from core.models.yolo.world.train_world import WorldTrainerFromScratch
        >>> from core.models import YOLOWorld
        >>> data = dict(
        ...     train=dict(
