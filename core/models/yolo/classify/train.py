...
from core.data import ClassificationDataset, build_dataloader
from core.engine.trainer import BaseTrainer
from core.models import yolo
from core.nn.tasks import ClassificationModel
from core.utils import DEFAULT_CFG, RANK
from core.utils.plotting import plot_images
from core.utils.torch_utils import is_parallel, torch_distributed_zero_first
...
class ClassificationTrainer(BaseTrainer):
    ...
    def setup_model(self):
        ...
        """
        import torchvision  # scope for faster 'import core'
