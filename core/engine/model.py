...
from core.cfg import TASK2DATA, get_cfg, get_save_dir
from core.engine.results import Results
from core.nn.tasks import guess_model_task, load_checkpoint, yaml_model_load
...
class Model(torch.nn.Module):
    ...
    def tune(
        ...
        **kwargs: Any,
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from core.utils.tuner import run_ray_tune
