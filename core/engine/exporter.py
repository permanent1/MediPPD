...
from core.cfg import TASK2DATA, get_cfg
from core.data import build_dataloader
from core.data.dataset import YOLODataset
from core.data.utils import check_cls_dataset, check_det_dataset
from core.nn.autobackend import check_class_names, default_class_names
from core.nn.modules import C2f, Classify, Detect, RTDETRDecoder
from core.nn.tasks import ClassificationModel, DetectionModel, SegmentationModel, WorldModel
...
from core.utils.files import file_size
from core.utils.metrics import batch_probiou
from core.utils.nms import TorchNMS
from core.utils.ops import Profile
from core.utils.patches import arange_patch
...
class Exporter:
    ...
    Examples:
        ...
        >>> from core.engine.exporter import Exporter
        >>> exporter = Exporter()
    ...
    def __call__(self, model=None) -> str:
        ...
        if imx:
            from core.utils.export.imx import FXModel

            model = FXModel(model, self.imgsz)
        if tflite or edgetpu:
            from core.utils.export.tensorflow import tf_wrapper
