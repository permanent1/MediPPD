...
from core.utils import LOGGER, DataExportMixin, SimpleClass, ops
from core.utils.plotting import Annotator, colors, save_one_box
...
class BaseTensor(SimpleClass):
    ...
    def cuda(self):
        ...
        Examples:
            >>> import torch
            >>> from core.engine.results import BaseTensor
            >>> data = torch.tensor([[1, 2, 3], [4, 5, 6]])
            >>> base_tensor = BaseTensor(data, orig_shape=(720, 1280))
            >>> gpu_tensor = base_tensor.cuda()
...
class Keypoints(BaseTensor):
    ...
    Examples:
        >>> import torch
        >>> from core.engine.results import Keypoints
