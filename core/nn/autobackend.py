...
from core.utils import ARM64, IS_JETSON, LINUX, LOGGER, PYTHON_VERSION, ROOT, YAML, is_jetson
from core.utils.checks import check_requirements, check_suffix, check_version, check_yaml, is_rockchip
from core.utils.downloads import attempt_download_asset, is_url
from core.utils.nms import non_max_suppression
...
class AutoBackend(nn.Module):
    ...
    def __init__(
        ...
        # TF GraphDef
            ...
            from core.utils.export.tensorflow import gd_outputs
        ...
        # NVIDIA Triton Inference Server
            ...
            from core.utils.triton import TritonRemoteModel
        ...
        # Any other format (unsupported)
            ...
            from core.engine.exporter import export_formats
