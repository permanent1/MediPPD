...
from core.nn.autobackend import check_class_names
...
from core.utils import DEFAULT_CFG_DICT, LOGGER, YAML, colorstr, emojis
from core.utils.checks import check_requirements, check_suffix, check_yaml
from core.utils.loss import (
    E2EDetectLoss,
...
from core.utils.ops import make_divisible
from core.utils.patches import torch_load
from core.utils.plotting import feature_visualization
...
class RTDETRDetectionModel(DetectionModel):
    ...
    def init_criterion(self):
        ...
        from core.models.utils.loss import RTDETRDetectionLoss
...
class WorldModel(DetectionModel):
    ...
    def get_text_pe(self, text, batch=80, cache_clip_model=True):
        ...
        """
        from core.nn.text_model import build_text_model
...
class YOLOEModel(DetectionModel):
    ...
    def loss(self, batch, preds=None):
        ...
        """
        if not hasattr(self, "criterion"):
            from core.utils.loss import TVPDetectLoss
...
class YOLOESegModel(YOLOEModel, SegmentationModel):
    ...
    def loss(self, batch, preds=None):
        ...
        """
        if not hasattr(self, "criterion"):
            from core.utils.loss import TVPSegmentLoss
...
def torch_safe_load(weight, safe_only=False):
    ...
    Examples:
        >>> from core.nn.tasks import torch_safe_load
        >>> ckpt, file = torch_safe_load("path/to/best.pt", safe_only=True)
    """
    from core.utils.downloads import attempt_download_asset
