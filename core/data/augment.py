...
from core.data.utils import polygons2masks, polygons2masks_overlap
from core.utils import LOGGER, IterableSimpleNamespace, colorstr
from core.utils.checks import check_version
from core.utils.instance import Instances
from core.utils.metrics import bbox_ioa
from core.utils.ops import segment2box, xywh2xyxy, xyxyxyxy2xywhr
from core.utils.torch_utils import TORCHVISION_0_10, TORCHVISION_0_11, TORCHVISION_0_13
...
class Mosaic(BaseMixTransform):
    ...
    Examples:
        >>> from core.data.augment import Mosaic
...
class MixUp(BaseMixTransform):
    ...
    Examples:
        >>> from core.data.augment import MixUp
        >>> dataset = YourDataset(...)  # Your image dataset
...
class CutMix(BaseMixTransform):
    ...
    Examples:
        >>> from core.data.augment import CutMix
        >>> dataset = YourDataset(...)  # Your image dataset
...
class RandomHSV:
    ...
    Examples:
        >>> import numpy as np
        >>> from core.data.augment import RandomHSV
...
class CopyPaste(BaseMixTransform):
    ...
    Examples:
        >>> from core.data.augment import CopyPaste
        >>> dataset = YourDataset(...)  # Your image dataset
...
def v8_transforms(dataset, imgsz: int, hyp: IterableSimpleNamespace, stretch: bool = False):
    ...
    Examples:
        >>> from core.data.dataset import YOLODataset
        >>> from core.utils import IterableSimpleNamespace
