...
from core.utils import ASSETS_URL, DATASETS_DIR, LOGGER, NUM_THREADS, TQDM, YAML
from core.utils.checks import check_file, check_requirements
from core.utils.downloads import download, zip_directory
from core.utils.files import increment_path
...
def convert_segment_masks_to_yolo_seg(masks_dir: str, output_dir: str, classes: int):
    ...
    Examples:
        >>> from core.data.converter import convert_segment_masks_to_yolo_seg
...
def yolo_bbox2segment(im_dir: str | Path, save_dir: str | Path | None = None, sam_model: str = "sam_b.pt", device=None):
    ...
    from core.data import YOLODataset
...
def create_synthetic_coco_dataset():
    ...
    Examples:
        >>> from core.data.converter import create_synthetic_coco_dataset
...
def convert_to_multispectral(path: str | Path, n_channels: int = 10, replace: bool = False, zip: bool = False):
    ...
    from core.data.utils import IMG_FORMATS
