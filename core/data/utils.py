...
from core.utils.checks import check_file, check_font, is_ascii
from core.utils.downloads import download, safe_download, unzip_file
from core.utils.ops import segments2boxes
...
def visualize_image_annotations(image_path: str, txt_path: str, label_map: dict[int, str]):
    ...
    from core.utils.plotting import colors
...
def check_cls_dataset(dataset: str | Path, split: str = "") -> dict[str, Any]:
    ...
    if not train_set.is_dir():
        ...
        if image_files := list(data_dir.rglob("*.jpg")) + list(data_dir.rglob("*.png")):
            from core.data.split import split_classify_dataset
...
class HUBDatasetStats:
    ...
    def process_images(self) -> Path:
        ...
        from core.data import YOLODataset  # ClassificationDataset
